...
```
	if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
		$config = array(
			...
			'proper_folder_name' => 'WordPress-GitHub-Plugin-Updater-master',
			'api_url' => 'https://api.github.com/repos/webmyne2290/pluginupdatenow',
			'raw_url' => 'https://raw.githubusercontent.com/webmyne2290/pluginupdatenow/master',
			'github_url' => 'https://github.com/webmyne2290/pluginupdatenow',
			'zip_url' => 'https://github.com/webmyne2290/pluginupdatenow/archive/master.zip',
			'sslverify' => false,
			'requires' => '3.8.2',
			'tested' => '5.4',
			'readme' => 'README.md',
